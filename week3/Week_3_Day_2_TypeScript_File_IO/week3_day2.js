...
var contents = fs.readFileSync("study_log.txt", "utf-8");
console.log(contents);
// console.log("\nExercise 3 — Async File Read");
/* Read study_log.txt asynchronously and print it. */
fs.readFile("study_log.txt", "utf-8", function (err, data) {
    if (err) {
...
var extraCreditFilePath = 'fileThatDoesNotExist.txt';
try {
    var data = fs.readFileSync(extraCreditFilePath, 'utf-8');
    ...
    if (error instanceof Error) {
        ...
        if ('code' in error && error.code === 'ENOENT') {
            console.error("The file was not found at path: ".concat(extraCreditFilePath));
        }
    }
    else {
